...
import { Truck, Mail, Lock, Globe, Layout, ArrowRight } from "lucide-react";
        ...
        <Card className="bg-[#0a0f1a] border-slate-800 shadow-2xl">
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between ml-1">
                  ...
                  <Link to="#" className="text-xs text-[#00D4FF] hover:underline">Forgot password?</Link>
                </div>
                <div className="relative">
            ...
            <div className="relative py-4">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-[#0a0f1a] px-2 text-slate-500">Or continue with</span>
              </div>
            </div>
          ...
          <CardFooter className="flex flex-col space-y-4">
            <div className="text-sm text-center text-slate-500">
              ...
              <Link to="/signup" className="text-[#00D4FF] font-bold hover:underline">Create an account</Link>
            </div>
          </CardFooter>
        </Card>
        
        <p className="mt-8 px-8 text-center text-xs text-slate-500 leading-relaxed">
          By clicking continue, you agree to our{" "}
          <Link to="#" className="underline underline-offset-4 hover:text-[#00D4FF]">Terms of Service</Link>{" "}
          and{" "}
          <Link to="#" className="underline underline-offset-4 hover:text-[#00D4FF]">Privacy Policy</Link>.
        </p>
      </div>
    </div>
  );
